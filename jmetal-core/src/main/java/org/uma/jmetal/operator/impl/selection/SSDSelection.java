 ...
 */
public class SSDSelection<S extends Solution<?>> implements SelectionOperator<List<S>,S> {
  private Comparator<S> comparator;

  private final int numberOfTournaments;

  /** Constructor */
  public SSDSelection(int numberOfTournaments) {
    this(new RankingAndSSDComparator<S>(), numberOfTournaments) ;
  }

  /** Constructor */
  public SSDSelection(Comparator<S> comparator, int numberOfTournaments) {
